...
# return tweets containing #devdiscuss
response = twitter.search(q='"#codeland"  -filter:retweets', result_type="recent", count=100)
...
for tweet in response['statuses']:
    ...
    try:
        ...
        twitter.add_list_member(slug='codeland-2019', owner_screen_name='waterproofheart', screen_name= tweet['user']['screen_name'])
